...
for (let i = 0; i < array.length; i++) {
    if ((array[i] + array[i + 1]) === 7) {
        console.log('сумма чисел ' + array[i] + ' и ' + array[i + 1] + ' равна 7');
    } else if ((array[0] + array[i]) === 7) {
        console.log('сумма чисел ' + array[0] + ' и ' + array[i] + ' равна 7');
    }
}
...
for ( let i = 0; i < allCars.length; i++) {
    temp = allCars[i].toString();//преобразуем в строки цифры массива
